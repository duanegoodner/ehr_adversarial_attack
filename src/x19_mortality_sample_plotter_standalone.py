...
class StandaloneX19MortalitySamplePlotter:
    def __init__(
        self,
    ...
    def plot_samples(
        ...
        for i, ax in enumerate(axes):
            ...
            predicted_label = predicted_labels[i] if predicted_labels else None
...
if __name__ == "__main__":
    my_plotter = StandaloneX19MortalitySamplePlotter()
    ...
    my_model = BinaryBidirectionalLSTM(

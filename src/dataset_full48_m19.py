...
class Full48M19Dataset(Dataset):
    ...
    FeatureFinalizer with settings.observation_window_in_hours = 48 &
    ...
    def from_feature_finalizer_output(
        cls,
        measurements_path: Path = pfin.FEATURE_FINALIZER_OUTPUT_DIR
        / "measurement_data_list.pickle",
        in_hospital_mort_path: Path = pfin.FEATURE_FINALIZER_OUTPUT_DIR
